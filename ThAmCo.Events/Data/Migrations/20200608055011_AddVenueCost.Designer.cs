...
namespace ThAmCo.Events.Data.Migrations
{
    ...
    [Migration("20200608055011_AddVenueCost")]
    partial class AddVenueCost
    {
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2016, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 6, 0, 0, 0), Title = "Bob's Big 50", TypeId = "PTY", VenueCost = 0m },
                        new { Id = 2, Date = new DateTime(2018, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 12, 0, 0, 0), Title = "Best Wedding Yet", TypeId = "WED", VenueCost = 0m }
                    );
                });
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Staff", b =>
                {
                    ...
                    b.HasData(
                        new { StaffId = 1, Email = "choo@fcuc.com", FirstAider = false, FirstName = "Neoh", Surname = "Finn" },
                        new { StaffId = 2, Email = "alex@fcuc.com", FirstAider = true, FirstName = "Lee", Surname = "Alex" },
                        new { StaffId = 3, Email = "leon@fcuc.com", FirstAider = true, FirstName = "Alexander", Surname = "Leon" }
                    );
                });
